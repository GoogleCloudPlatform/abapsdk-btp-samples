...
" --------------------------------------------------------------------
CLASS zcl_cs_batch_pr_processor_vers DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
...
CLASS zcl_cs_batch_pr_processor_vers IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    ...
    TRY.
        ...
        " Call API method
        lo_client->batch_process_processor_ver( EXPORTING iv_p_projects_id           = lv_p_projects_id
