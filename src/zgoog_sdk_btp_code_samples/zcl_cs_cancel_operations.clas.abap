...
" --------------------------------------------------------------------
CLASS zcl_cs_cancel_operations DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
...
CLASS zcl_cs_cancel_operations IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    ...
    TRY.
        ...
        " Operation ID of a Long Running Operation
        lv_p_operations_id = 'OPERATION_ID'.

        " Call API method
        lo_client->cancel_operations( EXPORTING iv_p_projects_id   = lv_p_projects_id
